...
## HTML Reports (Rendered Notebooks)

For convenience, rendered HTML versions of the main empirical outputs are available:

- Rolling Forecast Report:  
  `results/reports/03_rolling_forecast.html`

- VaR Backtesting Report:  
  `results/reports/04_var_backtesting.html`

These files contain the full output, figures, and tables generated by the notebooks.
