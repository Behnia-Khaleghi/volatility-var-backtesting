...
The objective is to evaluate whether modeling volatility asymmetry (leverage effects) improves out-of-sample volatility forecasts and market risk estimation.
...
Processed returns are stored in:
...
Both models are estimated using maximum likelihood.
